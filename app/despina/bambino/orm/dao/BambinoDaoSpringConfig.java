package despina.bambino.orm.dao;
 ...
 */
@Configuration
@EnableJpaRepositories("despina.bambino.orm.entities")
@EnableTransactionManagement
@ComponentScan
public class BambinoDaoSpringConfig {
    @Bean
...
/*    @Bean
    ...
    public EntityManagerFactory getLocalEntityManagerFactoryBean() {
        ...
        factory.setJpaVendorAdapter(getJpaVendorAdapter());
        factory.setPersistenceUnitName("bambino-pu");
